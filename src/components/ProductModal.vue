                ...
                <div class="col-4">
                    <div class="row">
                        <div class="col-12 mb-3 d-flex flex-column">
                            <input type="text" placeholder="請輸入圖片網址" name="imageUrl"
                            class="form-control" :class="{'is-invalid': !tempProduct.imageUrl}"
                            v-model="imageUrl" v-if="!imageUrl">
                            <span class="invalid-feedback" name="imageUrl">請輸入主圖照片</span>
                            <input type="file" :disabled="disabled" @change="loadFile">
                            <button type="button" class="btn btn-primary me-3"
                            @click="addProductImage">新增</button>
                        </div>
                        <div class="col-12 mb-3 position-relative" v-if="imageUrl">
                            <img :src="imageUrl" alt="edit product pic"
                            class="object-fit-cover w-100">
                            <span class="position-absolute top-0 start-75 translate-middle
                            badge rounded-circle bg-danger me-3"
                    ...
                    <div class="row">
                        <div class="col-6 position-relative mb-3" v-if="tempProduct.imageUrl">
                            ...
                            class="object-fit-cover w-100">
                            <span class="position-absolute top-0 start-75 translate-middle
                            badge rounded-circle bg-danger me-3" @click="deleteTempImage">
                                -
                                <span class="visually-hidden">unread messages</span>
                            </span>
                        </div>
                ...
                <div class="col-8">
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <div class="w-100 d-flex flex-column">
                            <v-field type="text" id="title" class="form-control"
                            :class="{'is-invalid': errors.Title}" name="Title"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <div class="w-100 d-flex flex-column">
                                    <v-field type="text" id="category" class="form-control"
                                    :class="{'is-invalid': errors.Category}" name="Category"
                                    v-model="tempProduct.category" rules="required"></v-field>
                                    <error-message class="invalid-feedback"
                                    name="Category"></error-message>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <div class="w-100 d-flex flex-column">
                                    <v-field type="text" id="unit" class="form-control"
                                    :class="{'is-invalid': errors.Unit}" name="Unit"
                                    v-model="tempProduct.unit" rules="required"></v-field>
                                    <error-message class="invalid-feedback"
                                    name="Unit"></error-message>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <div class="w-100 d-flex flex-column">
                            <v-field type="number" id="num" class="form-control"
                            :class="{'is-invalid': errors.Number}" name="Number"
                            v-model="tempProduct.num" rules="required"></v-field>
                            <error-message class="invalid-feedback"
                    ...
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <div class="w-100 d-flex flex-column">
                            <v-field type="text" id="content" class="form-control"
                            :class="{'is-invalid': errors.Content}" name="Content"
                            v-model="tempProduct.content" rules="required"></v-field>
                            <error-message class="invalid-feedback"
                            name="Content"></error-message>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description：</label>
                        <div class="w-100">
                            <v-field name="Description" rules="required"
                            v-model="tempProduct.description">
                                <textarea name="Description" class="w-100"
                                :class="{'is-invalid': errors.Description}" id="description"
                                cols="30" rows="3" placeholder="請輸入產品描述"
                    ...
                    <div class="mb-3 d-flex align-items-center">
                        <input type="checkbox" id="is_enabled" class="form-check-input me-2"
                        :checked="tempProduct.is_enabled" v-model="tempProduct.is_enabled">
...
export default {
  ...
  methods: {
    ...
    async putProduct(obj) {
      try {
        this.$emit('emit-toggleLoading');
        const result = (await this.axios.put(`${apiUrl}/v2/api/${apiPath}/admin/product/${this.tempProduct.id}`, obj));
        this.$emit('emit-toggleLoading');
